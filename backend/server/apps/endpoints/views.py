...
from server.wsgi import registery
import datetime
...
class PredictView(views.APIView):
    def post(self, request, endpoint_name, format=None):
        ...
        if len(algs) == 0:
            return Response({"status": "Error", "message": "ML algorithm not available"},
        ...
        algorithm_object = registery.endpoints[algs[alg_index].id]
